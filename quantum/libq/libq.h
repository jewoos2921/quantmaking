...
#define HASH_CASH_SIZE (1024 * 64)

    struct qureg_t {
        cmplx *amplitude;
        state_t *state;
        int width; /* number of qubit in the qureg */
        int size; /* number of non-zero vectors */
        int max_size; /* largest size reached */
        int hash_computes; /* how often is the hash table computed */
        int hash_w; /* width of the hash array */
        int *hash;
        ...
        //
        // This can be enabled by setting hash_cashing to true.
        //
        bool hash_cashing; /* cache hash values, optional */
        int *hash_hits;
        int hits;
